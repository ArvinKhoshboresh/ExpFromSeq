...
def train_model():
    ...
    sequences_df = sequences_df[:12000]
    expression_df = expression_df[:12000]
    ...
    model = RandomForestRegressor(n_estimators=20, random_state=42, n_jobs=32)
